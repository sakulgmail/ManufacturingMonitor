...
const icons = {
  factory: <SettingsIcon className="h-16 w-16 text-gray-600" />,
  gauge: <SettingsIcon className="h-16 w-16 text-gray-600" />,
  monitor: <SettingsIcon className="h-16 w-16 text-gray-600" />
};
